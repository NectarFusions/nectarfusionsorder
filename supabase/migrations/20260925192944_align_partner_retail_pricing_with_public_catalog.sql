-- NectarFusions partner retail pricing alignment
-- Mirrors the production migration already applied on 2026-09-25.
-- Adds 4 oz partner replenishment and derives partner jar pricing
-- from the public retail price at 50%.
...
declare
  ...
  v_price_version constant text := 'retail-half-2026-09';
  v_spun_enabled boolean := false;
