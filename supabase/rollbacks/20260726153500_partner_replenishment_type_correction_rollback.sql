...
-- Targeted rollback for the replenishment type-correction migration.
--
-- WARNING: This restores the prior function definitions and therefore
-- restores the two known PostgreSQL honey_type/text lint errors.
-- Run only after explicit diagnosis and approval.
