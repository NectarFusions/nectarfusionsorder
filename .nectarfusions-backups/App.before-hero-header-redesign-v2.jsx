    ...
    <div className="nf"><style>{CSS}</style>
      ...
      <div className="nf-wrap" style={{ paddingTop: 22 }}>
        <div style={{
          ...
          borderRadius: 18,
          overflow: "hidden",
          border: "1px solid rgba(74,51,19,.16)",
          boxShadow: "0 12px 28px rgba(74,51,19,.14)",
          background: "#2E241B"
        }}>
          <img
            src="/nectarfusions-honey-hero.webp"
            alt="NectarFusions premium honey jar"
            style={{
              display: "block",
              width: "100%",
              height: "clamp(210px, 42vw, 340px)",
              objectFit: "cover",
