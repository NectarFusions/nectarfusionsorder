      ...
      {cart.length > 0 && (
        <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, background: c.cocoa, padding: "13px 18px" }}>
          <div style={{ maxWidth: 720, margin: "0 auto", display: "flex", alignItems: "center", gap: 14 }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 11.5, color: c.tan, fontWeight: 500, lineHeight: 1.45 }}>
              ...
              <div style={{ fontSize: 11, color: c.tan, marginTop: 4, textTransform: "uppercase", letterSpacing: ".08em" }}>
                Order total
              </div>
